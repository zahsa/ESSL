...
setup(
    ...
    install_requires=['absl-py==1.0.0', 'aiohttp==3.8.1', 'aiosignal==1.2.0',
                      ...
                      'importlib-metadata==4.11.3', 'ipykernel==6.13.0', 'ipython==8.3.0', 'jedi==0.18.1',
                      ...
                      'mycolorpy==1.5.1', 'nest-asyncio==1.5.5', 'numpy==1.23.0', 'oauthlib==3.2.0', 'omegaconf==2.1.2',
                      'packaging==21.3', 'pandas==1.4.3', 'parso==0.8.3', 'pexpect==4.8.0', 'pickleshare==0.7.5',
                      ...
                      'scipy==1.8.0', 'seaborn==0.11.2', 'six==1.16.0', 'sklearn==0.0', 'stack-data==0.2.0', 'tensorboard==2.8.0',
    ...
    entry_points={
        "console_scripts": ["essl_GA = essl.main:GA_cli", "essl_GA_bootstrap = essl.main:GA_bootstrap_cli", "essl_GA_mo = essl.main:GA_mo_cli", "essl_GA_mo_bootstrap = GA_mo_bootstrap_cli"]
    },
)
